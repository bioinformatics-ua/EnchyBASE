<html>
    <head><title>ViroBLAST results - EnchyBASE</title>
    ...
    <body>
        ...
        <div id="indent">
            ...
            if (!$opt || $opt == 'wait') {
                ...
                echo "<h2>Your job is being processed ";
                for ($i = 0; $i <= ($dot % 6); $i++) {
                ...
                echo "<div class=\"ui-state-highlight ui-corner-all\" style=\"margin-top: 20px; padding: 0 .7em;\"><br /><p><span class=\"ui-icon ui-icon-info\" style=\"float: left; margin-right: .7em;\"></span>";
                echo "Please wait here to watch the progress of your job.";
                echo "<br>This page will update itself automatically until search is done.";
                echo "</p><br /></div>";
            }
                ...
                if ($alignmentView) {
                    ...
                    if (!$opt || $opt == 'wait') {
                        ...
                        if ($cutoff_count == 0) {
                            ...
                            echo "<p><a href='viroblast.php' id='backback'>Go Back</a></p><br /><br /><p><a href=data/$jobid.blast1.html target='_blank'>Inspect BLAST output</a><br><br />";
                            ...
                            if ($blast_flag == 'Parse again' || ($opt == 'none' && !$filter_flag)) {
                                ...
                                while (!feof($fpout3)) {
                                    ...
                                    if (count($element) != 1) {
                                        ...
                                        if ($i < 10) {
                                            echo "<tr align='center'><td>$element[1]</td><td align='left'>$target_name</td><td><a href=data/$jobid.blast$page.html#$element[1]$element[2] target='_blank'>$element[3]</a></td><td>$element[4]</td><td>$element[5]</td><td>$element[6]</td></tr>";
    ...
    <script>
        $(document).ready(function(){
            $('#bblast,#breset,#ablast,#areset,#backback').button();             
        });
    </script>
</html>
